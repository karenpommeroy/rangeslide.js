  ...
  if (typeof define === 'function' && define.amd) {
	...
	Rangeslide.prototype = {
        ...
        refresh: function() {
            ...
            this.setMinValue(this.getMinValue().index);
            this.setMaxValue(this.getMaxValue().index);
        ...
        setValueByAttribute: function(attributeName, attributeValue) {
            ...
            this.setValue(l - 1, this.__thumbLeft);
        },
        ...
        setMaxValue: function(index) {
			if (this.isSingleMode()) return this.setValue(index, this.__thumbLeft);
        ...
        setMinValueByAttribute: function (attributeName, attributeValue) {
            ...
            this.setMinValue(l - 1, this.__thumbLeft);
        },
        ...
        setMaxValueByAttribute: function (attributeName, attributeValue) {
            ...
            if (this.isSingleMode()) return this.setValue(l - 1, this.__thumbLeft);
            
            this.setMinValue(l - 1, this.__thumbRight);
        },
		...
		__onMarkerClicked: function(event) {
			if(this.isSelectMode()) {
                ...
                this.__snap(event.currentTarget.offsetLeft + this.config.markerSize / 2);
            }
        ...
        __snap: function(positionX, thumb, noAnimation) {
			if (this.config.spacing === "data-driven") {
                ...
                newLeft = closestMarker.offsetLeft;
                closestThumbElement.setLeft(newLeft);
                nextMarker = closestMarker.dataset.id;
			...
			if (this.config.showTrackMarkersProgress) {
				clearInterval(this.__markersUpdateInterval);
                this.__markersUpdateInterval = setInterval(this.__onUpdateMarkersProgress, 50);
			}				
			...
			this.__onValueChanged(closestThumbElement.getValue(), nextValue, closestThumbElement);
		...
		__createTrackProgressElement: function() {
			...
			trackProgressElement.className = "track-progress noselect" + (this.config.animations ? " anim" : "");
		...
		__createLabels: function (parent, everyOtherLabel, skipFirst, labelsBeforeTicks) {
            ...
            for (var i = skipFirst ? 1 : 0; i <= total; everyOtherLabel ? i += 2 : i++) {				
                ...
                span.innerText = this.__getLabelContent(this.config.data[i]);
        ...
        __attachTooltips: function (markers) {
            ...
            while (l--) {
                ...
                tooltipElement.innerText = this.__getTooltipContent(this.config.data[l]);
        ...
        __getLabelContent: function (item) {
            if (this.__isString(this.config.labelContent)) {
                return item[this.config.labelContent];
            }
            else if (typeof this.config.labelContent === "function") {
                return this.config.labelContent.call(this, item);
            }
            else {
                return item;
            }
        ...
        __getTooltipContent: function (item) {
            if (this.__isString(this.config.tooltipContent)) {
                return item[this.config.tooltipContent];
            }
            else if (typeof this.config.tooltipContent === "function") {
                return this.config.tooltipContent.call(this, item);
            }
            else {
                return item;
            }
        ...
        __isDataTemporal: function() {
            ...
            while (l--) {
                ...
                if (!(item instanceof Date) || typeof item.getMonth != 'function') {
                    return false;
                }
            }
            return true;
